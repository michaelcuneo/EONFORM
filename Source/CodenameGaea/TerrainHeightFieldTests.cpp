...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"CodenameGaea.Legacy.HeightField.SharedStorage",
...
bool FTerrainHeightFieldSharedStorageTest::RunTest(const FString& Parameters)
{
	...
	TestEqual(TEXT("Legacy Data write should update scalar field storage"), HeightField.GetGaeaField().AtInterior(1, 1), 0.25f);
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"CodenameGaea.Legacy.HeightField.ValueSemantics",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)
