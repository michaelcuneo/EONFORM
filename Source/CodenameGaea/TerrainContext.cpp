	...
	FTerrainContextMaps& OutContext)
{
	...
	TerrainParallel::ForRows(TEXT("TerrainContextAnalyze"), Resolution, [&](int32 StartY, int32 EndY)
	{
	...
	FTerrainProcessMasks& OutMasks)
{
	...
	TerrainParallel::ForRange(TEXT("TerrainProcessMasks"), NumCells, 65536, [&](int32 Start, int32 End)
	{
