...
{
	FEonformScalarField ElevationField;
	FEonformScalarField SlopeDegreesField;
	FEonformScalarField ConcavityField;
	FEonformScalarField ConvexityField;
	FEonformScalarField MountainField;
	FEonformScalarField FoothillField;
	FEonformScalarField PlainsField;
	...
	{
		const FEonformGridDomain& Domain = HeightField.GetEonformDomain();
...
{
	FEonformScalarField ThermalField;
	FEonformScalarField RainfallField;
	FEonformScalarField HydraulicErosionField;
	FEonformScalarField DepositionField;
	FEonformScalarField EvaporationField;
