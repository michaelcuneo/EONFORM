...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	FEonformSemanticTerrainFieldsTest,
	"Eonform.Legacy.SemanticFields.ContextGeologyMasks",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FEonformSemanticTerrainFieldsTest::RunTest(const FString& Parameters)
{
	...
	TestEqual(TEXT("Slope field unit"), static_cast<uint8>(Context.SlopeDegreesField.Descriptor.Unit), static_cast<uint8>(EEonformFieldUnit::Degrees));
	TestTrue(TEXT("Elevation field domain matches heightfield"), Context.ElevationField.Domain == HeightField.GetEonformDomain());
	...
	TestEqual(TEXT("Soil depth field unit"), static_cast<uint8>(Geology.SoilDepthField.Descriptor.Unit), static_cast<uint8>(EEonformFieldUnit::Normalized));
