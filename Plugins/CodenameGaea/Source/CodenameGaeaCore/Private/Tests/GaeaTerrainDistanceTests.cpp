...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	FGaeaTerrainDistanceDescriptorTest,
	"CodenameGaea.Core.Graph.DistanceDescriptor",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FGaeaTerrainDistanceDescriptorTest::RunTest(const FString& Parameters)
{
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	FGaeaTerrainDistanceTerminalTest,
	"CodenameGaea.Core.Graph.DistanceTerminalOut",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FGaeaTerrainDistanceTerminalTest::RunTest(const FString& Parameters)
{
	...
	FGaeaTerrainNode Distance;
	Distance.Id = FGuid(0xB2000001, 0xB2000002, 0xB2000003, 0xB2000004);
	Distance.Type = GaeaTerrainNodeTypes::Distance;
	...
	GaeaDistanceTests::Connect(Recipe, Source.Id, TEXT("Terrain"), Distance.Id, TEXT("Input"));
