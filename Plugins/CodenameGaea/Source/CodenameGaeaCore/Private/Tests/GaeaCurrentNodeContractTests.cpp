...
bool FGaeaCurrentNodeContractTest::RunTest(const FString& Parameters)
{
	...
	CheckNode(*this, GaeaTerrainNodeTypes::Curve, TEXT("Curve"), TEXT("Modify"), 4);
	...
	CheckNode(*this, GaeaTerrainNodeTypes::DirectionalWarp, TEXT("DirectionalWarp"), TEXT("Modify"), 3);
	...
	CheckNode(*this, GaeaTerrainNodeTypes::Filter, TEXT("Filter"), TEXT("Modify"), 3);
	CheckNode(*this, GaeaTerrainNodeTypes::Flip, TEXT("Flip"), TEXT("Modify"), 1);
	CheckNode(*this, GaeaTerrainNodeTypes::Fold, TEXT("Fold"), TEXT("Modify"), 3);
	CheckNode(*this, GaeaTerrainNodeTypes::GraphicEQ, TEXT("GraphicEQ"), TEXT("Modify"), 5);
	CheckNode(*this, GaeaTerrainNodeTypes::Heal, TEXT("Heal"), TEXT("Modify"), 3);
	CheckNode(*this, GaeaTerrainNodeTypes::Match, TEXT("Match"), TEXT("Modify"), 3);
	CheckNode(*this, GaeaTerrainNodeTypes::Median, TEXT("Median"), TEXT("Modify"), 2);
	CheckNode(*this, GaeaTerrainNodeTypes::Meshify, TEXT("Meshify"), TEXT("Modify"), 2);
	CheckNode(*this, GaeaTerrainNodeTypes::Origami, TEXT("Origami"), TEXT("Modify"), 2);
	CheckNode(*this, GaeaTerrainNodeTypes::Pixelate, TEXT("Pixelate"), TEXT("Modify"), 2);
