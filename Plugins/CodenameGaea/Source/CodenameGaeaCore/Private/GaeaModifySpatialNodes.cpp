...
namespace GaeaModifySpatialNodesPrivate
{
	FGaeaTerrainPortDescriptor SpatialPort(FName Name, const TCHAR* Label)
	{
	...
	FGaeaTerrainParameterDescriptor SpatialNumber(FName Name, const TCHAR* Label, double DefaultValue, double Min, double Max)
	{
		FGaeaTerrainParameterDescriptor P;
		P.Name = Name; P.DisplayName = Label; P.Type = EGaeaTerrainParameterType::Number; P.DefaultNumber = DefaultValue;
		P.bHasMinimum = true; P.Minimum = Min; P.bHasMaximum = true; P.Maximum = Max;
		return P;
	}

	FGaeaTerrainParameterDescriptor SpatialInteger(FName Name, const TCHAR* Label, int64 DefaultValue, int64 Min, int64 Max)
	{
		FGaeaTerrainParameterDescriptor P;
		P.Name = Name; P.DisplayName = Label; P.Type = EGaeaTerrainParameterType::Integer; P.DefaultInteger = DefaultValue;
		P.bHasMinimum = true; P.Minimum = static_cast<double>(Min); P.bHasMaximum = true; P.Maximum = static_cast<double>(Max);
		return P;
	}

	FGaeaTerrainParameterDescriptor SpatialBool(FName Name, const TCHAR* Label, bool DefaultValue)
	{
		FGaeaTerrainParameterDescriptor P;
		P.Name = Name; P.DisplayName = Label; P.Type = EGaeaTerrainParameterType::Boolean; P.DefaultBoolean = DefaultValue;
		return P;
	}

	FGaeaTerrainParameterDescriptor SpatialName(FName Name, const TCHAR* Label, FName DefaultValue, std::initializer_list<FName> Options)
	{
		FGaeaTerrainParameterDescriptor P;
		P.Name = Name; P.DisplayName = Label; P.Type = EGaeaTerrainParameterType::Name; P.DefaultName = DefaultValue;
		for (const FName Option : Options) P.NameOptions.Add(Option);
		return P;
	}

	const FGaeaScalarField* FieldFromValue(const FGaeaTerrainValue* Value)
	{
	...
	float SampleGridBilinear(const FGaeaScalarField& Field, float X, float Y, bool bMirror)
	{
	...
	void GradientAt(const FGaeaScalarField& Field, int32 X, int32 Y, float& GX, float& GY)
	{
		GX = 0.5f * (SampleClamped(Field, X + 1, Y) - SampleClamped(Field, X - 1, Y));
		GY = 0.5f * (SampleClamped(Field, X, Y + 1) - SampleClamped(Field, X, Y - 1));
	}

	using FSpatialProcessor = TFunction<bool(const FGaeaTerrainNode&, const FGaeaScalarField&, const FGaeaScalarField*, FGaeaScalarField&, FString&)>;

	bool EvaluateSpatial(const TCHAR* Label, const FGaeaTerrainNode& Node, const FGaeaTerrainNodeInputs& Inputs, FGaeaTerrainNodeEvaluation& Out, FString& Error, const FSpatialProcessor& Processor)
	{
		...
		const FGaeaTerrainValue* const* GuidePtr = Inputs.Find(TEXT("Guide"));
		const FGaeaScalarField* Guide = FieldFromValue(GuidePtr ? *GuidePtr : nullptr);
		const FGaeaScalarField* Source = FieldFromValue(Input);
	...
	bool DirectionalWarpField(const FGaeaTerrainNode& Node, const FGaeaScalarField& Source, const FGaeaScalarField* Guide, FGaeaScalarField& Out, FString& Error)
	{
	...
	bool FoldField(const FGaeaTerrainNode& Node, const FGaeaScalarField& Source, const FGaeaScalarField*, FGaeaScalarField& Out, FString& Error)
	{
	...
	bool MeshifyField(const FGaeaTerrainNode& Node, const FGaeaScalarField& Source, const FGaeaScalarField*, FGaeaScalarField& Out, FString& Error)
	{
	...
	bool OrigamiField(const FGaeaTerrainNode& Node, const FGaeaScalarField& Source, const FGaeaScalarField*, FGaeaScalarField& Out, FString& Error)
	{
	...
	bool SlopeBlurField(const FGaeaTerrainNode& Node, const FGaeaScalarField& Source, const FGaeaScalarField* Guide, FGaeaScalarField& Out, FString& Error)
	{
		if (!Source.IsValid()) { Error = TEXT("SlopeBlur received an invalid field."); return false; }
		const FGaeaScalarField& G = Guide ? *Guide : Source;
	...
	bool SlopeWarpField(const FGaeaTerrainNode& Node, const FGaeaScalarField& Source, const FGaeaScalarField* Guide, FGaeaScalarField& Out, FString& Error)
	{
		...
		FGaeaScalarField Current = Source, Next = Source;
	...
	bool SwirlField(const FGaeaTerrainNode& Node, const FGaeaScalarField& Source, const FGaeaScalarField*, FGaeaScalarField& Out, FString& Error)
	{
	...
	bool ThermalShaperField(const FGaeaTerrainNode& Node, const FGaeaScalarField& Source, const FGaeaScalarField*, FGaeaScalarField& Out, FString& Error)
	{
	...
	bool TransposeField(const FGaeaTerrainNode& Node, const FGaeaScalarField& Source, const FGaeaScalarField* Guide, FGaeaScalarField& Out, FString& Error)
	{
	...
	bool VariableBlurField(const FGaeaTerrainNode& Node, const FGaeaScalarField& Source, const FGaeaScalarField* Guide, FGaeaScalarField& Out, FString& Error)
	{
	...
	bool WarpField(const FGaeaTerrainNode& Node, const FGaeaScalarField& Source, const FGaeaScalarField* Guide, FGaeaScalarField& Out, FString& Error)
	{
	...
	bool WhorlField(const FGaeaTerrainNode& Node, const FGaeaScalarField& Source, const FGaeaScalarField*, FGaeaScalarField& Out, FString& Error)
	{
	...
	void RegisterSpatialSimple(FName Type, const TCHAR* DisplayName, const TCHAR* Description, std::initializer_list<FGaeaTerrainParameterDescriptor> Parameters, const FSpatialProcessor& Processor, bool bGuide = false)
	{
		...
		for (const FGaeaTerrainParameterDescriptor& P : Parameters) D.Parameters.Add(P);
		FGaeaTerrainNodeDescriptorRegistry::Register(D);
		const FString Label(DisplayName);
		FGaeaTerrainNodeRegistry::Register(Type, [Label, Processor](const FGaeaTerrainNode& Node, const FGaeaTerrainNodeInputs& Inputs, const FGaeaTerrainEvaluationContext&, FGaeaTerrainNodeEvaluation& Out, FString& Error)
		{
