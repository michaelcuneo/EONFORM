...
namespace
{
	...
	using FFieldProcessor = TFunction<bool(const FGaeaTerrainNode&, const FGaeaScalarField&, bool, FGaeaScalarField&, FString&)>;
	...
	void FieldMinMax(const FGaeaScalarField& Source, float& OutMin, float& OutMax)
	{
	...
	bool AdjustField(const FGaeaTerrainNode& Node, const FGaeaScalarField& Source, bool bTerrain, FGaeaScalarField& OutField, FString& Error)
	{
	...
	bool ApertureField(const FGaeaTerrainNode& Node, const FGaeaScalarField& Source, bool, FGaeaScalarField& OutField, FString& Error)
	{
	...
	bool BlobRemoverField(const FGaeaTerrainNode& Node, const FGaeaScalarField& Source, bool bTerrain, FGaeaScalarField& OutField, FString& Error)
	{
	...
	bool ClipField(const FGaeaTerrainNode& Node, const FGaeaScalarField& Source, bool bTerrain, FGaeaScalarField& OutField, FString& Error)
	{
	...
	bool DeflateField(const FGaeaTerrainNode& Node, const FGaeaScalarField& Source, bool, FGaeaScalarField& OutField, FString& Error)
	{
	...
	bool DilateField(const FGaeaTerrainNode& Node, const FGaeaScalarField& Source, bool, FGaeaScalarField& OutField, FString& Error)
	{
	...
	bool EqualizeField(const FGaeaTerrainNode&, const FGaeaScalarField& Source, bool bTerrain, FGaeaScalarField& OutField, FString& Error)
	{
	...
	bool ExtendField(const FGaeaTerrainNode& Node, const FGaeaScalarField& Source, bool bTerrain, FGaeaScalarField& OutField, FString& Error)
	{
	...
	bool MedianField(const FGaeaTerrainNode& Node, const FGaeaScalarField& Source, bool, FGaeaScalarField& OutField, FString& Error)
	{
	...
	void RegisterNode(FName Type, const TCHAR* DisplayName, const TCHAR* Description, TArray<FGaeaTerrainParameterDescriptor>&& Parameters, FGaeaTerrainNodeEvaluator Evaluator)
	{
		...
		FGaeaTerrainNodeRegistry::Register(Type, MoveTemp(Evaluator));
	}
}

void RegisterGaeaAdjustNode()
{
	TArray<FGaeaTerrainParameterDescriptor> P;
	...
	RegisterNode(GaeaTerrainNodeTypes::Adjust, TEXT("Adjust"), TEXT("Combines common value remapping operations in one modifier node."), MoveTemp(P), [](const FGaeaTerrainNode& N, const FGaeaTerrainNodeInputs& I, const FGaeaTerrainEvaluationContext&, FGaeaTerrainNodeEvaluation& O, FString& E){ return EvaluateAnyFieldNode(TEXT("Adjust"), N, I, O, E, AdjustField); });
}

void RegisterGaeaApertureNode()
{
	TArray<FGaeaTerrainParameterDescriptor> P;
	...
	RegisterNode(GaeaTerrainNodeTypes::Aperture, TEXT("Aperture"), TEXT("Expands or compacts features using configurable morphological kernels."), MoveTemp(P), [](const FGaeaTerrainNode& N, const FGaeaTerrainNodeInputs& I, const FGaeaTerrainEvaluationContext&, FGaeaTerrainNodeEvaluation& O, FString& E){ return EvaluateAnyFieldNode(TEXT("Aperture"), N, I, O, E, ApertureField); });
}

void RegisterGaeaBlobRemoverNode()
{
	TArray<FGaeaTerrainParameterDescriptor> P;
	...
	RegisterNode(GaeaTerrainNodeTypes::BlobRemover, TEXT("BlobRemover"), TEXT("Removes small disconnected fragments while preserving larger shapes."), MoveTemp(P), [](const FGaeaTerrainNode& N, const FGaeaTerrainNodeInputs& I, const FGaeaTerrainEvaluationContext&, FGaeaTerrainNodeEvaluation& O, FString& E){ return EvaluateAnyFieldNode(TEXT("BlobRemover"), N, I, O, E, BlobRemoverField); });
}

void RegisterGaeaClipNode()
{
	TArray<FGaeaTerrainParameterDescriptor> P;
	...
	RegisterNode(GaeaTerrainNodeTypes::Clip, TEXT("Clip"), TEXT("Cuts values outside a selected range, with optional automatic percentile clipping."), MoveTemp(P), [](const FGaeaTerrainNode& N, const FGaeaTerrainNodeInputs& I, const FGaeaTerrainEvaluationContext&, FGaeaTerrainNodeEvaluation& O, FString& E){ return EvaluateAnyFieldNode(TEXT("Clip"), N, I, O, E, ClipField); });
}

void RegisterGaeaDeflateNode()
{
	TArray<FGaeaTerrainParameterDescriptor> P;
	P.Add(NumberParam(TEXT("Amount"), TEXT("Amount"), 0.5, 0.0, 1.0));
	RegisterNode(GaeaTerrainNodeTypes::Deflate, TEXT("Deflate"), TEXT("Removes low-frequency bulk while preserving finer terrain structure."), MoveTemp(P), [](const FGaeaTerrainNode& N, const FGaeaTerrainNodeInputs& I, const FGaeaTerrainEvaluationContext&, FGaeaTerrainNodeEvaluation& O, FString& E){ return EvaluateAnyFieldNode(TEXT("Deflate"), N, I, O, E, DeflateField); });
}

void RegisterGaeaDilateNode()
{
	TArray<FGaeaTerrainParameterDescriptor> P;
	...
	P.Add(BoolParam(TEXT("Invert"), TEXT("Invert"), false));
	RegisterNode(GaeaTerrainNodeTypes::Dilate, TEXT("Dilate"), TEXT("Expands heightfield or mask features using a selectable kernel."), MoveTemp(P), [](const FGaeaTerrainNode& N, const FGaeaTerrainNodeInputs& I, const FGaeaTerrainEvaluationContext&, FGaeaTerrainNodeEvaluation& O, FString& E){ return EvaluateAnyFieldNode(TEXT("Dilate"), N, I, O, E, DilateField); });
}

void RegisterGaeaEqualizeNode()
{
	TArray<FGaeaTerrainParameterDescriptor> P;
	RegisterNode(GaeaTerrainNodeTypes::Equalize, TEXT("Equalize"), TEXT("Redistributes values to use the available range more uniformly."), MoveTemp(P), [](const FGaeaTerrainNode& N, const FGaeaTerrainNodeInputs& I, const FGaeaTerrainEvaluationContext&, FGaeaTerrainNodeEvaluation& O, FString& E){ return EvaluateAnyFieldNode(TEXT("Equalize"), N, I, O, E, EqualizeField); });
}

void RegisterGaeaExtendNode()
{
	TArray<FGaeaTerrainParameterDescriptor> P;
	P.Add(NumberParam(TEXT("Value"), TEXT("Value"), 1.0, 0.0, 4.0));
	RegisterNode(GaeaTerrainNodeTypes::Extend, TEXT("Extend"), TEXT("Stretches the usable elevation or mask range beyond its current intensity."), MoveTemp(P), [](const FGaeaTerrainNode& N, const FGaeaTerrainNodeInputs& I, const FGaeaTerrainEvaluationContext&, FGaeaTerrainNodeEvaluation& O, FString& E){ return EvaluateAnyFieldNode(TEXT("Extend"), N, I, O, E, ExtendField); });
}

void RegisterGaeaMedianNode()
{
	TArray<FGaeaTerrainParameterDescriptor> P;
	P.Add(IntegerParam(TEXT("Radius"), TEXT("Radius"), 1, 1, 8));
	P.Add(NumberParam(TEXT("Amount"), TEXT("Amount"), 1.0, 0.0, 1.0));
	RegisterNode(GaeaTerrainNodeTypes::Median, TEXT("Median"), TEXT("Removes isolated noise while retaining stronger edges using a median filter."), MoveTemp(P), [](const FGaeaTerrainNode& N, const FGaeaTerrainNodeInputs& I, const FGaeaTerrainEvaluationContext&, FGaeaTerrainNodeEvaluation& O, FString& E){ return EvaluateAnyFieldNode(TEXT("Median"), N, I, O, E, MedianField); });
}
