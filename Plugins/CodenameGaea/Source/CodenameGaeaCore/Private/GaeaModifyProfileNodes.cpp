...
namespace GaeaModifyProfileNodesPrivate
{
	FGaeaTerrainPortDescriptor ProfileAnyPort(FName Name, const TCHAR* Label)
	{
	...
	FGaeaTerrainParameterDescriptor ProfileNumberParam(FName Name, const TCHAR* Label, double DefaultValue, double Min, double Max)
	{
	...
	FGaeaTerrainParameterDescriptor ProfileIntegerParam(FName Name, const TCHAR* Label, int64 DefaultValue, int64 Min, int64 Max)
	{
		FGaeaTerrainParameterDescriptor P;
		P.Name = Name;
		P.DisplayName = Label;
	...
	FGaeaTerrainParameterDescriptor ProfileNameParam(FName Name, const TCHAR* Label, FName DefaultValue, std::initializer_list<FName> Options)
	{
		FGaeaTerrainParameterDescriptor P;
		P.Name = Name;
		P.DisplayName = Label;
	...
	float ProfileSampleClamped(const FGaeaScalarField& Field, int32 X, int32 Y)
	{
	...
	using FProfileProcessor = TFunction<bool(const FGaeaTerrainNode&, const FGaeaScalarField&, bool, FGaeaScalarField&, FString&)>;

	bool EvaluateProfileNode(const TCHAR* Label, const FGaeaTerrainNode& Node, const FGaeaTerrainNodeInputs& Inputs, FGaeaTerrainNodeEvaluation& Out, FString& Error, const FProfileProcessor& Processor)
	{
	...
	void RegisterProfileSimple(FName Type, const TCHAR* DisplayName, const TCHAR* Description, std::initializer_list<FGaeaTerrainParameterDescriptor> Parameters, const FProfileProcessor& Processor)
	{
...
{
	using namespace GaeaModifyProfileNodesPrivate;
	RegisterProfileSimple(GaeaTerrainNodeTypes::Curve, TEXT("Curve"), TEXT("Remaps terrain or mask values with shadow, midtone, highlight, and contrast controls."),
...
{
	using namespace GaeaModifyProfileNodesPrivate;
	RegisterProfileSimple(GaeaTerrainNodeTypes::Filter, TEXT("Filter"), TEXT("Applies low-pass, high-pass, or band-pass filtering to terrain or masks."),
...
{
	using namespace GaeaModifyProfileNodesPrivate;
	RegisterProfileSimple(GaeaTerrainNodeTypes::GraphicEQ, TEXT("GraphicEQ"), TEXT("Shapes low, mid, and high elevation bands independently."),
...
{
	using namespace GaeaModifyProfileNodesPrivate;
	RegisterProfileSimple(GaeaTerrainNodeTypes::Heal, TEXT("Heal"), TEXT("Repairs isolated spikes and pits while preserving surrounding terrain."),
...
{
	using namespace GaeaModifyProfileNodesPrivate;
	RegisterProfileSimple(GaeaTerrainNodeTypes::Match, TEXT("Match"), TEXT("Matches mean elevation and contrast to a target statistical profile."),
...
{
	using namespace GaeaModifyProfileNodesPrivate;
	RegisterProfileSimple(GaeaTerrainNodeTypes::Pixelate, TEXT("Pixelate"), TEXT("Reduces spatial detail into configurable sample blocks."),
