...
struct CODENAMEGAEACORE_API FGaeaTerrainShapeSettings
{
	int32 Seed = 1337;
...
/** Pure terrain-form shaping derived from the legacy Codename Gaea terrain generator. */
class CODENAMEGAEACORE_API FGaeaTerrainShaping
{
public:
