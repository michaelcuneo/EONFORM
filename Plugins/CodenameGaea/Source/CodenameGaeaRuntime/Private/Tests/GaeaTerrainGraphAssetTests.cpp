...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	FGaeaTerrainGraphAssetModelTest,
	"CodenameGaea.Runtime.GraphAsset.Model",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FGaeaTerrainGraphAssetModelTest::RunTest(const FString& Parameters)
{
	UGaeaTerrainGraphAsset* Asset = NewObject<UGaeaTerrainGraphAsset>();
	...
	const FGaeaTerrainNodeLayout* ErosionLayout = Asset->FindLayout(Erosion.Id);
	...
	const FGaeaTerrainNode* StoredErosion = Asset->Recipe.FindNode(Erosion.Id);
