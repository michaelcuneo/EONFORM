...
namespace EonformTerrainProceduralOps
{
	namespace
	{
		constexpr float EonformMinWarpSize = 0.0001f;                    // e002(101)
		constexpr float EonformNormalizedWarpEpsilon = 0.1f;             // e002(93)
		constexpr float EonformFinalPerturbFrequencyMultiplier = 4.0f;    // e002(4)
		constexpr float EonformFinalPerturbWarpMultiplier = 0.25f;        // e002(76)
		constexpr float EonformDirectionCycleDegrees = 360.0f;            // e002(128)
			...
			int32 Seed)
		{
			...
			{
				return EonformFastNoiseSIMDCompat::PerlinFBM(
					NX,
					NY,
					NZ,
					FMath::Max(Octaves, 1),
			...
			const EonformFastNoiseSIMDCompat::FCellularSample Cellular =
				EonformFastNoiseSIMDCompat::Cellular(
					NX,
					NY,
					NZ,
					Jitter,
					EonformFastNoiseSIMDCompat::ECellularDistance::Euclidean,
					Seed,
					true);
