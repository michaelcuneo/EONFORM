...
namespace
{
	FEonformTerrainPortDescriptor DriftNoiseTerrainPort(FName Name)
	{
...
void RegisterEonformDriftNoiseNode()
{
	FEonformTerrainNodeDescriptor Descriptor;
	Descriptor.Type = EonformTerrainNodeTypes::DriftNoise;
	...
	FEonformTerrainNodeRegistry::Register(EonformTerrainNodeTypes::DriftNoise, EvaluateDriftNoiseNode);
}
