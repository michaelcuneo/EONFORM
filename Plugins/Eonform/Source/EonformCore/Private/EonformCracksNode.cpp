...
namespace
{
	FEonformTerrainPortDescriptor CracksTerrainPort(FName Name, const TCHAR* DisplayName = nullptr)
	{
	...
	FEonformTerrainParameterDescriptor CracksNumberParameter(FName Name, const TCHAR* DisplayName, double DefaultValue, double Minimum, double Maximum, const TCHAR* Group = nullptr)
	{
	...
	FEonformTerrainParameterDescriptor CracksIntegerParameter(FName Name, const TCHAR* DisplayName, int64 DefaultValue, int64 Minimum, int64 Maximum, const TCHAR* Group = nullptr)
	{
		FEonformTerrainParameterDescriptor Parameter;
		Parameter.Name = Name;
		Parameter.DisplayName = DisplayName;
	...
	FEonformTerrainParameterDescriptor CracksNameParameter(FName Name, const TCHAR* DisplayName, FName DefaultValue, std::initializer_list<FName> Options, const TCHAR* Group = nullptr)
	{
		FEonformTerrainParameterDescriptor Parameter;
		Parameter.Name = Name;
		Parameter.DisplayName = DisplayName;
	...
	FEonformGridDomain ResolveDomain(const FEonformTerrainNode& Node, const FEonformTerrainEvaluationContext& Context)
	{
		...
		return FEonformGridDomain::Make(FIntPoint(Width, Height), FVector2d(-WidthCm * 0.5, -DepthCm * 0.5), FVector2d(WidthCm * 0.5, DepthCm * 0.5));
	}
	...
	bool EvaluateCracksNode(const FEonformTerrainNode& Node, const FEonformTerrainNodeInputs&, const FEonformTerrainEvaluationContext& Context, FEonformTerrainNodeEvaluation& Out, FString& Error)
	{
		const FEonformGridDomain Domain = ResolveDomain(Node, Context);
		...
		FEonformTerrainValue Result = FEonformTerrainValue::MakeTerrain(MoveTemp(Dataset), ResolveHeightScale(Node, Context));
...
void RegisterEonformCracksNode()
{
	FEonformTerrainNodeDescriptor Descriptor;
	Descriptor.Type = EonformTerrainNodeTypes::Cracks;
	...
	FEonformTerrainNodeRegistry::Register(EonformTerrainNodeTypes::Cracks, EvaluateCracksNode);
}
