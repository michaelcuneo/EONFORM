...
namespace
{
	...
	bool EvaluateDrawNode(const FEonformTerrainNode& Node, const FEonformTerrainNodeInputs&, const FEonformTerrainEvaluationContext&, FEonformTerrainNodeEvaluation& Out, FString& Error)
	{
		...
		FEonformScalarField Field; Field.Initialize(Domain, Descriptor);
...
{
	FEonformTerrainNodeDescriptor Descriptor; Descriptor.Type = EonformTerrainNodeTypes::Draw; Descriptor.DisplayName = TEXT("Draw"); Descriptor.Category = TEXT("Primitive"); Descriptor.Description = TEXT("Draws authored mountain-range strokes using the Painter workflow.");
	...
	FEonformTerrainNodeDescriptorRegistry::Register(Descriptor); FEonformTerrainNodeRegistry::Register(EonformTerrainNodeTypes::Draw, EvaluateDrawNode);
}
...
void RegisterEonformObjectNode()
{
	...
	FEonformTerrainNodeDescriptorRegistry::Register(Descriptor); FEonformTerrainNodeRegistry::Register(EonformTerrainNodeTypes::Object, EvaluateObjectNode);
}
...
void RegisterEonformTileInputNode()
{
	...
	FEonformTerrainNodeDescriptorRegistry::Register(Descriptor); FEonformTerrainNodeRegistry::Register(EonformTerrainNodeTypes::TileInput, EvaluateTileInputNode);
}
