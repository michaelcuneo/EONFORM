...
namespace EonformPrimitiveCoverage
{
	...
	{
		FEonformTerrainPortDescriptor Port; Port.Name = TEXT("Out"); Port.DisplayName = TEXT("Out"); Port.DataType = TEXT("Terrain"); return Port;
	}
	...
	{
		FEonformGridDomain Domain; float HeightScale = 8000.0f;
		...
		FEonformTerrainDataset Dataset; if (!Dataset.SetScalarField(MoveTemp(Field))) { Error = TEXT("Primitive could not publish Height."); return false; }
		FEonformTerrainValue Result = FEonformTerrainValue::MakeTerrain(MoveTemp(Dataset), HeightScale); if (!Result.IsValid()) { Error = TEXT("Primitive produced invalid terrain."); return false; }
...
{
	using namespace EonformPrimitiveCoverage; FEonformTerrainNodeDescriptor D; D.Type = EonformTerrainNodeTypes::LineNoise; D.DisplayName = TEXT("LineNoise"); D.Category = TEXT("Primitive"); D.Description = TEXT("Generates directional line sets for layered ridges and procedural patterns."); D.Outputs.Add(TerrainOut());
	...
	FEonformTerrainNodeDescriptorRegistry::Register(D); FEonformTerrainNodeRegistry::Register(EonformTerrainNodeTypes::LineNoise, EvalLineNoise);
}

void RegisterEonformNoiseNode()
{
	using namespace EonformPrimitiveCoverage; FEonformTerrainNodeDescriptor D; D.Type = EonformTerrainNodeTypes::Noise; D.DisplayName = TEXT("Noise"); D.Category = TEXT("Primitive"); D.Description = TEXT("Applies controlled pixel and procedural noise."); D.Outputs.Add(TerrainOut());
	...
	FEonformTerrainNodeDescriptorRegistry::Register(D); FEonformTerrainNodeRegistry::Register(EonformTerrainNodeTypes::Noise, EvalNoise);
}

void RegisterEonformPatternNode()
{
	using namespace EonformPrimitiveCoverage; FEonformTerrainNodeDescriptor D; D.Type = EonformTerrainNodeTypes::Pattern; D.DisplayName = TEXT("Pattern"); D.Category = TEXT("Primitive"); D.Description = TEXT("Generates repeatable geometric patterns for masks and stylized terrain."); D.Outputs.Add(TerrainOut());
	...
	FEonformTerrainNodeDescriptorRegistry::Register(D); FEonformTerrainNodeRegistry::Register(EonformTerrainNodeTypes::Pattern, EvalPattern);
}

void RegisterEonformShapeNode()
{
	using namespace EonformPrimitiveCoverage; FEonformTerrainNodeDescriptor D; D.Type = EonformTerrainNodeTypes::Shape; D.DisplayName = TEXT("Shape"); D.Category = TEXT("Primitive"); D.Description = TEXT("Generates basic geometric terrain shapes for primitives and masks."); D.Outputs.Add(TerrainOut());
	...
	FEonformTerrainNodeDescriptorRegistry::Register(D); FEonformTerrainNodeRegistry::Register(EonformTerrainNodeTypes::Shape, EvalShape);
}
...
{
	using namespace EonformPrimitiveCoverage; FEonformTerrainNodeDescriptor D; D.Type = EonformTerrainNodeTypes::WaveShine; D.DisplayName = TEXT("WaveShine"); D.Category = TEXT("Primitive"); D.Description = TEXT("Generates animated ripple and wind-patch patterns with lighting controls."); D.Outputs.Add(TerrainOut());
	...
	FEonformTerrainNodeDescriptorRegistry::Register(D); FEonformTerrainNodeRegistry::Register(EonformTerrainNodeTypes::WaveShine, EvalWaveShine);
}
