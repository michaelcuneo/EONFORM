...
namespace EonformReferenceFidelity
{
	...
	FEonformTerrainParameterDescriptor Number(FName Name, const TCHAR* Label, double Default, double Min, double Max, const TCHAR* Group = nullptr)
	{
	...
	FEonformTerrainParameterDescriptor Integer(FName Name, const TCHAR* Label, int64 Default, int64 Min, int64 Max, const TCHAR* Group = nullptr)
	{
		FEonformTerrainParameterDescriptor P;
		P.Name = Name;
		P.DisplayName = Label;
	...
	FEonformTerrainParameterDescriptor Boolean(FName Name, const TCHAR* Label, bool Default, const TCHAR* Group = nullptr)
	{
		FEonformTerrainParameterDescriptor P;
		P.Name = Name;
		P.DisplayName = Label;
	...
	FEonformGridDomain BuildSourceDomain(const FEonformTerrainNode& Node, const FEonformTerrainEvaluationContext& Context)
	{
	...
	bool PublishHeight(FEonformScalarField&& Height, float HeightScale, FEonformTerrainNodeEvaluation& Out, FString& Error)
	{
	...
	bool EvaluateRadialGradient(const FEonformTerrainNode& Node, const FEonformTerrainNodeInputs&, const FEonformTerrainEvaluationContext& Context, FEonformTerrainNodeEvaluation& Out, FString& Error)
	{
		const FEonformGridDomain Domain = BuildSourceDomain(Node, Context);
	...
	const FEonformScalarField* AsScalar(const FEonformTerrainValue* V)
	{
	...
	bool EvaluateCombine(const FEonformTerrainNode& Node, const FEonformTerrainNodeInputs& Inputs, const FEonformTerrainEvaluationContext&, FEonformTerrainNodeEvaluation& Out, FString& Error)
	{
		...
		const FEonformScalarField* B = AsScalar(BValue);
		...
		const FEonformScalarField* Mask = AsScalar(Input(Inputs, TEXT("Mask")));
	...
	void RegisterRadialGradient()
	{
		...
		FEonformTerrainNodeRegistry::Register(D.Type, EvaluateRadialGradient);
	}
	...
	void RegisterCombine()
	{
		...
		FEonformTerrainNodeDescriptorRegistry::Register(D);
		FEonformTerrainNodeRegistry::Register(D.Type, EvaluateCombine);
	}
}

void RegisterEonformReferenceFidelityNodes()
{
	using namespace EonformReferenceFidelity;
