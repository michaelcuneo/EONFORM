...
namespace
{
	bool ValidateSameDomain(const FEonformScalarField& A, const FEonformScalarField& B, const TCHAR* Operation, FString* OutError)
	{
	...
	float SampleWrapped(const FEonformScalarField& Field, int32 X, int32 Y)
	{
	...
	FLinearColor SampleWrapped(const FEonformColorField& Field, int32 X, int32 Y)
	{
		const int32 W = Field.Domain.Dimensions.X;
		const int32 H = Field.Domain.Dimensions.Y;
		X = (X % W + W) % W;
...
bool FEonformTerrainUtilityOps::EvaluateMath(const FEonformScalarField& A, const FEonformScalarField* B, const FEonformScalarField* C, const FEonformTerrainUtilityMathSettings& Settings, FEonformScalarField& OutField, FString* OutError)
{
...
bool FEonformTerrainUtilityOps::Compare(const FEonformScalarField& A, const FEonformScalarField& B, float Ratio, bool bPerpendicular, bool bSwap, FEonformScalarField& OutField, FEonformColorField* OutColorized, FString* OutError)
{
...
bool FEonformTerrainUtilityOps::ApplyMask(const FEonformScalarField& After, const FEonformScalarField& Before, const FEonformScalarField& Mask, FEonformScalarField& OutField, FString* OutError)
{
...
bool FEonformTerrainUtilityOps::MakeSeamless(const FEonformScalarField& Input, float Edge, float ShiftX, float ShiftY, FEonformScalarField& OutField, FString* OutError)
{
...
bool FEonformTerrainUtilityOps::MakeSeamless(const FEonformColorField& Input, float Edge, float ShiftX, float ShiftY, FEonformColorField& OutField, FString* OutError)
{
...
bool FEonformTerrainUtilityOps::Repeat(const FEonformScalarField& Input, int32 Tiles, bool bCompensateHeight, float Height, FEonformScalarField& OutField, FString* OutError)
{
...
bool FEonformTerrainUtilityOps::MixColors(const TArray<FEonformTerrainUtilityColorLayer>& Layers, FEonformColorField& OutField, FString* OutError)
{
	...
	{
		const FEonformTerrainUtilityColorLayer& L = Layers[I];
...
int32 FEonformTerrainUtilityOps::MutateSeed(int32 BaseSeed, int32 OverrideSeed)
{
