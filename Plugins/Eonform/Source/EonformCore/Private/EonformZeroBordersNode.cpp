...
namespace
{
	FEonformTerrainPortDescriptor ZeroBordersTerrainPort(FName Name, const TCHAR* DisplayName = nullptr)
	{
	...
	FEonformTerrainParameterDescriptor ZeroBordersNumberParameter(FName Name, const TCHAR* DisplayName, double DefaultValue, double Minimum, double Maximum)
	{
	...
	FEonformTerrainParameterDescriptor ZeroBordersIntegerParameter(FName Name, const TCHAR* DisplayName, int64 DefaultValue, int64 Minimum, int64 Maximum)
	{
		FEonformTerrainParameterDescriptor Parameter;
		Parameter.Name = Name;
		Parameter.DisplayName = DisplayName;
	...
	FEonformTerrainParameterDescriptor ZeroBordersNameParameter(FName Name, const TCHAR* DisplayName, FName DefaultValue)
	{
		FEonformTerrainParameterDescriptor Parameter;
		Parameter.Name = Name;
		Parameter.DisplayName = DisplayName;
	...
	bool ZeroBordersApplyToHeight(const FEonformTerrainNode& Node, const FEonformScalarField& Source, FEonformScalarField& OutField, FString& Error)
	{
		if (!Source.IsValid())
		{
	...
	bool EvaluateZeroBordersNode(const FEonformTerrainNode& Node, const FEonformTerrainNodeInputs& Inputs, const FEonformTerrainEvaluationContext&, FEonformTerrainNodeEvaluation& Out, FString& Error)
	{
...
void RegisterEonformZeroBordersNode()
{
	FEonformTerrainNodeDescriptor Descriptor;
	Descriptor.Type = EonformTerrainNodeTypes::ZeroBorders;
	...
	FEonformTerrainNodeRegistry::Register(EonformTerrainNodeTypes::ZeroBorders, EvaluateZeroBordersNode);
}
