...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	FEonformAdvancedHydraulicChannelFormationTest,
	"Eonform.Core.Hydraulic.AdvancedChannelFormation",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FEonformAdvancedHydraulicChannelFormationTest::RunTest(const FString& Parameters)
{
	...
	const FEonformScalarField Before = Height;
