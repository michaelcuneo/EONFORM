...
namespace EonformLakeNode
{
		...
		FString& Error)
	{
		...
		FEonformScalarField LakeMask = MakeScalar(Source->Domain, TEXT("Lake"));
		FEonformScalarField Depth = MakeScalar(Source->Domain, TEXT("LakeDepth"), EEonformFieldUnit::Meters);
		FEonformScalarField Shore = MakeScalar(Source->Domain, TEXT("LakeShore"));
		FEonformScalarField Surface = MakeScalar(Source->Domain, TEXT("LakeSurface"), EEonformFieldUnit::Meters);
		...
		FEonformScalarField LakeOutput = LakeMask;
		...
		Out.Outputs.Add(TEXT("Lake"), FEonformTerrainValue::MakeScalarField(MoveTemp(LakeOutput)));
...
void RegisterEonformLakeNode()
{
	using namespace EonformLakeNode;

	FEonformTerrainNodeDescriptor Descriptor;
	Descriptor.Type = EonformTerrainNodeTypes::Lake;
	...
	FEonformTerrainNodeRegistry::Register(Descriptor.Type, EvaluateLake);
}
