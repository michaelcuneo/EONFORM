...
namespace
{
	...
	void ParseGeoKeys(TArrayView<const uint16> Keys, FEonformGeoTiffMetadata& OutMetadata)
	{
...
bool EonformReadGeoTiffMetadata(
	const FString& Path,
	int32 RasterWidth,
	int32 RasterHeight,
	FEonformGeoTiffMetadata& OutMetadata)
{
	OutMetadata = FEonformGeoTiffMetadata();
