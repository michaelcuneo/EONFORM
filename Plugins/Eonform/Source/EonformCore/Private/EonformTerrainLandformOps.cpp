#include "EonformTerrainLandformOps.h"
...
namespace
{
	...
	FEonformScalarField MakeField(const FEonformGridDomain& Domain, FName Name)
	{
...
bool FEonformTerrainLandformOps::BuildMountain(
	const FEonformMountainLandformSettings& InSettings,
	const FEonformTerrainPhysicalMetrics& PhysicalMetrics,
	FEonformMountainLandformResult& OutResult,
	FString* OutError)
{
	FEonformMountainLandformSettings Settings = InSettings;
	...
	FEonformScalarField Height = MakeField(Domain, EonformTerrainFieldNames::Height);
	FEonformScalarField Mass = MakeField(Domain, EonformTerrainFieldNames::MountainMass);
	FEonformScalarField Uplift = MakeField(Domain, EonformTerrainFieldNames::Uplift);
	FEonformScalarField Ridges = MakeField(Domain, EonformTerrainFieldNames::RidgeNetwork);
	FEonformScalarField Drainage = MakeField(Domain, EonformTerrainFieldNames::DrainageReadiness);
	FEonformScalarField Erosion = MakeField(Domain, EonformTerrainFieldNames::ErosionEligibility);
	FEonformScalarField Rock = MakeField(Domain, EonformTerrainFieldNames::RockExposure);
	FEonformScalarField Cryosphere = MakeField(Domain, EonformTerrainFieldNames::CryosphereEligibility);
	...
	if (!FEonformTerrainDerivedData::EnsureContext(Dataset, Settings.HeightScale, PhysicalMetrics, &ContextError))
	{
