...
#include "EonformMeshTerrainBridgeActor.generated.h"
...
class EONFORMMESHTERRAINEDITOR_API AEonformMeshTerrainBridgeActor : public AActor
{
	GENERATED_BODY()

public:
	AEonformMeshTerrainBridgeActor();
	...
	TObjectPtr<UEonformTerrainGraphAsset> GraphAsset;
