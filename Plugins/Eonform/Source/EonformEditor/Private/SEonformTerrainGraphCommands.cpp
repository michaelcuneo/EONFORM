...
FReply SEonformTerrainGraphPanel::OnPreviewKeyDown(const FGeometry& MyGeometry, const FKeyEvent& InKeyEvent)
{
...
bool SEonformTerrainGraphPanel::CanDeleteSelectedNodes() const
{
...
void SEonformTerrainGraphPanel::DeleteSelectedNodes()
{
