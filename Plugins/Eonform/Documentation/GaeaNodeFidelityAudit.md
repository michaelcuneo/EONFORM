...
Existing shallow `CurrentEonformNodeContracts` remains useful for broad inventory, but it is no longer considered evidence of behavioral fidelity by itself.
